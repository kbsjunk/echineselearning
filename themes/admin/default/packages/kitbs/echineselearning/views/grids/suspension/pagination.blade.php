<script type="text/template" data-grid="suspension" data-template="pagination">
		...
		<div class="pull-left">
			...
			<div class="btn-group dropup">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="#" data-action="disable">{{{ trans('kitbs/echineselearning::suspensions/table.button.bulk.disable') }}}</a></li>
					<li><a href="#" data-action="enable">{{{ trans('kitbs/echineselearning::suspensions/table.button.bulk.enable') }}}</a></li>
				</ul>
		...
		<div class="pull-right">
			...
			<ul class="pagination pagination-sm">
				...
				<% if (p.previous_page !== null) { %>
					...
					<li><a href="#" data-page="<%= p.previous_page %>"><i class="fa fa-angle-left"></i></a></li>
				...
				<% if (p.next_page !== null) { %>
					...
					<li><a href="#" data-page="<%= p.next_page %>"><i class="fa fa-angle-right"></i></a></li>
