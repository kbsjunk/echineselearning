<script type="text/template" data-grid="lesson" data-template="pagination">
		...
		<div class="pull-left">
			...
			<div class="btn-group dropup">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="#" data-action="disable">{{{ trans('kitbs/echineselearning::lessons/table.button.bulk.disable') }}}</a></li>
					<li><a href="#" data-action="enable">{{{ trans('kitbs/echineselearning::lessons/table.button.bulk.enable') }}}</a></li>
				</ul>
